      ...
      <div id="sidebar-menu">
        <ul>
          ...
          @if(\App\Helper\CustomHelper::canView('', 'Institute Head'))
            <li>
              <a href="{{ route('admin.api') }}" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> API</span>
              </a>
            </li>
          @endif
          ...
          {{--          @if(\App\Helper\CustomHelper::canView('', 'Institute Head'))--}}
          {{--            <li><a href="{{ route('form') }}" class="waves-effect"><i>--}}
          {{--                  <iconify-icon icon="icon-park-outline:two-dimensional-code-two"></iconify-icon>--}}
          {{--                </i> <span>EAF IDG</span>--}}
          {{--              </a></li>--}}
          {{--            <li><a href="{{ route('eligibility.rpl.without.score') }}" class="waves-effect"><i>--}}
          {{--                  <iconify-icon icon="icon-park-outline:two-dimensional-code-two"></iconify-icon>--}}
          {{--                </i> <span>EAF RPL</span>--}}
          {{--              </a></li>--}}
          {{--            <li><a href="{{ route('eligibility.rpl.createOrStore') }}" class="waves-effect"><i>--}}
          {{--                  <iconify-icon icon="icon-park-outline:two-dimensional-code-two"></iconify-icon>--}}
          {{--                </i> <span>EAF RPL</span>--}}
          {{--              </a></li>--}}
          {{--            <li><a href="{{ route('eligibility.course.createOrStore') }}" class="waves-effect"><i>--}}
          {{--                  <iconify-icon icon="icon-park-outline:two-dimensional-code-two"></iconify-icon>--}}
          {{--                </i> <span>EAF Short Course</span>--}}
          {{--              </a></li>--}}
          {{--          @endif--}}
        ...
        @endif
          ...
          @endif
          @if(\App\Helper\CustomHelper::canView('Create Payment|Manage Payment|Delete Payment|View Payment|List Of Payment', 'Super Admin|Institute Head'))
            <li class="has_sub">

              <a class="waves-effect"><i class="mdi mdi-city"></i><span> Payment <span
                    class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                @if(\App\Helper\CustomHelper::canView('', 'Super Admin'))
                  <li><a href="{{ route('admin.payment.create') }}">Create new</a></li>
                @endif
                @if(\App\Helper\CustomHelper::canView('Manage Payment|Delete Payment|View Payment|List Of Payment', 'Super Admin|Institute Head'))
                  <li><a href="{{ route('admin.payment.list') }}">Payments</a></li>
                @endif
              </ul>
            </li>
          @endif
          {{--            @if(\App\Helper\CustomHelper::canView('', 'Super Admin'))--}}
          {{--                <li><a href="{{ route('add_payment_info') }}" class="waves-effect"><i>--}}
          {{--                            <iconify-icon icon="icon-park-outline:two-dimensional-code-two"></iconify-icon>--}}
          {{--                        </i> <span>Add Payment Info</span>--}}
          {{--                    </a></li>--}}
          {{--            @endif--}}
          ...
          {{--                    <a class="waves-effect"><i class="mdi mdi-city"></i><span> TTP Form <span--}}
          {{--                                class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>--}}
          {{--                    <ul class="list-unstyled">--}}
          {{--                        @if(\App\Helper\CustomHelper::canView('Create Division', 'Super Admin'))--}}
          {{--                            <li><a href="{{ route('ttp') }}">TTP FORM CREATE</a></li>--}}
          {{--                        @endif--}}
          {{--                        @if(\App\Helper\CustomHelper::canView('Create Division', 'Super Admin'))--}}
          {{--                                <li><a href="{{ route('app') }}">APP FORM CREATE</a></li>--}}
          {{--                        @endif--}}
          {{--                    </ul>--}}
          {{--                </li>--}}
          {{--            @endif--}}
          ...
          @if(\App\Helper\CustomHelper::canView('', 'Institute Head'))
            <li><a href="{{ route('admin.technology.create') }}" class="waves-effect">
                ...
                <span>Department/ Technology/ Trade/ Occupation</span>
              </a></li>
          @endif
            ...
            <li class="has_sub">
              ...
              <ul class="list-unstyled">
                @if(\App\Helper\CustomHelper::canView('Create Institute User', ''))
                  ...
                  <li><a href="{{ route('admin.institute.head.employee.create') }}">Create new Emplyer</a></li>
                @endif
                @if(\App\Helper\CustomHelper::canView('Manage Institute User|Delete Institute User|View Institute User|List Of Institute User', ''))
                  <li><a href="{{ route('admin.institute.head.employee.list') }}">List of Employer</a></li>
                @endif
              </ul>
            </li>
          @endif
          ...
          @if(\App\Helper\CustomHelper::canView('', 'Industry|Institute Head'))
            <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-account-multiple"></i><span>Job Applied Students<span
                    class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                {{-- @if(\App\Helper\CustomHelper::canView('Create Industry', 'Industry|Institute Head'))
                  <li><a href="{{ route('admin.job.post.create') }}">Create new</a></li>
                @endif --}}
                @if(\App\Helper\CustomHelper::canView('Manage Industry|Delete Industry|View Industry|List Of Industry', 'Industry|Institute Head'))
                  <li><a href="{{ route('applied.student.list') }}">List of Job Posts</a></li>
                @endif
              </ul>
            </li>
          @endif
          ...
          <ul class="list-inline float-right mb-0">
            ...
            <li class="list-inline-item dropdown notification-list">
              ...
              <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                ...
                @endif
                @if(\App\Helper\CustomHelper::canView('', 'Industry|Student'))
