           ...
           <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                <form action="{{ route('admin.sitereview.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-sm-6">
              ...
              {{--  @if(\App\Helper\CustomHelper::canView('Create User', 'Super Admin'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.sitereview.create') }}" class="brn btn-success btn-sm">Create new Review</a>
                  </div>
                </div>
              @endif  --}}
                  ...
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    @if(\App\Helper\CustomHelper::canView('Manage User|Delete User', 'Super Admin'))
                      <td class="center hidden-phone p-1" width="100">
                        ...
                        @endif  --}}
                        @if(\App\Helper\CustomHelper::canView('Manage User', 'Super Admin'))
                        <a href="{{ route('admin.sitereview.manage', $val->id) }}" class="btn btn-sm btn-success" title="Edit"> <i
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      {{--  $(document).on('change', 'input[name="onoffswitch"]', function () {
        ...
        $.ajax({
          url: "{{ route('admin.ajax.update.sitereview.status') }}",
          method: "post",
          dataType: "html",
      ...
      $(document).on('click', '.yes-btn', function () {
        ...
        $.ajax({
          url: "{{ route('admin.sitereview.destroy') }}",
          method: "delete",
          dataType: "html",
          data: {id: pid},
          success: function (data) {
      ...
      $(document).on('click', '.btn-manage', function () {
        ...
        var url = '{{ route("admin.sitereview.manage", ":id") }}';
