                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" id="job_context" name="job_context" placeholder="Job Description" autocomplete="off"
...
{{--                  <div class="col-sm-4">--}}
{{--                    <div class="form-group">--}}
{{--                      <label class="control-label" for="job_title">Tag Technology</label>--}}
{{--                      <input type="text" name="job_title" placeholder="Tag Technology" autocomplete="off"--}}
{{--                             value="{{ old('job_title') }}"--}}
{{--                             class="form-control @error('job_title') is-invalid @enderror">--}}
{{--                      @error('job_title')--}}
{{--                      <strong class="text-danger">{{ $errors->first('job_title') }}</strong>--}}
...
{{--                  </div>--}}
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="control-label">Tags<span
                            ...
                            <select name="tag"
                                ...
                                @foreach ($datas as $data)
                                    <option value="{{ $data->name }}"
                                            @if (old('tag') == $data->name) selected @endif>
                                        {{ ucfirst($data->name) }}</option>
                                @endforeach
                            </select>
                            @error('tag')
                            <strong
                                class="text-danger">{{ $errors->first('tag') }}</strong>
                            @enderror
