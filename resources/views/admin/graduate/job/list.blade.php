...
{{--                  <th class="hidden-phone" width="40">Option</th>--}}
                ...
                @foreach($datas as $key => $val)
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    <td class="p-1 text-capitalize"><a class="text-primary" href="{{route('job_post_details',$val->post_id)}}">{{ $val->post?->company_name }}</a></td>
                    {{-- <td class="p-1 text-capitalize">{{ $val->post?->user?->name_en }}</td> --}}
                    ...
                    <td class="p-1">{{ucfirst( $val?->institue_acceptance) }}</td>
