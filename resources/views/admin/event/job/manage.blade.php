                        ...
                        <div class="panel-body">
                            <div class="row">
                                @if (\App\Helper\CustomHelper::canView('', 'Institute Head'))
                                    <div class="col-md-3">
                                        <a href="{{ route('admin.event.job.participant.industry.list', request('id')) }}"class="btn btn-lg btn-light mt-1"
                                            style="width: 100%">Industry List</a>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <a href="{{ route('admin.job.post.jobfair.job.list', $job_event->id) }}"class="btn btn-lg btn-light mt-1"
                                          style="width: 100%">Job Fair Job List</a>
                                  </div>
                                @endif
                                @if (\App\Helper\CustomHelper::canView('', 'Industry'))
                                    @if ($status->status == 'accepted')
                                        <div class="col-md-3">
                                            {{--                    <a href="{{route('admin.job.post.create'),$job_event->id}}"class="btn btn-lg btn-light mt-1" style="width: 100%">Post Job</a> --}}
                                            <a href="{{ route('admin.job.post.create.jobFairPost', $job_event->id) }}"class="btn btn-lg btn-light mt-1"
