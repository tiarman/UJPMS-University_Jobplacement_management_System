        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create New Setting</h2>
            </header>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.setting.list') }}" class="brn btn-success btn-sm">List of Settting</a>
                </div>
              </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <select id="model-value-parent"  name="key" required class="form-control @error('key') is-invalid @enderror">
                        ...
                        @foreach(\App\Models\Setting::$keyArray as $key)
                         ...
                         @if(old('key') == $key) selected @endif>{{ ucfirst($key) }}</option>
                        @endforeach
                      </select>
                    </div>
                    ...
                    <div class="col-sm-12 " id="defaultValue">
                      <div class="form-group">
                        ...
                        <textarea name="value" required class="form-control @error('value') is-invalid @enderror" id="" cols="40" rows="3" placeholder="Give your info">{{ old('value') }}</textarea>
