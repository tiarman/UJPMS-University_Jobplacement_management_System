                            ...
                            @if (\App\Helper\CustomHelper::canView('Create Institute User', 'Super Admin'))
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                                        <a href="{{ route('admin.institute.head.student.create') }}"
                                            class="brn btn-success btn-sm">Add Graduate</a>
                                    </div>
                                </div>
                            @endif
                                ...
                                <tbody>
                                    @foreach ($datas as $key => $val)
                                        <tr class="@if ($key % 2 == 0) gradeX @else gradeC @endif">
                                            ...
                                            <td class="p-1 text-capitalize"><span
                                                    style="font-weight: bold; font-size: 16px">{{ $val->name_en }}</span><br>
                                                <span
                                            ...
                                            <td>
                                                <a href="{{ route('admin.institute.head.student.profile', $val->id) }}"
                                                ...
                                                <td class="text-capitalize p-1" width="100">
                                                    <div class="onoffswitch">
                                                        <input type="checkbox" name="onoffswitch"
                                                            class="onoffswitch-checkbox" @checked($val->status == \App\Models\User::$statusArrays[1])
                                                            data-id="{{ $val->id }}"
