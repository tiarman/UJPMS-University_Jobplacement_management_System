        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create Employer</h2>
            </header>
            <div class="panel-body">
              @if(\App\Helper\CustomHelper::canView('List Of Institute', 'Super Admin|Institute Head'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.institute.head.employee.list') }}" class="brn btn-success btn-sm">List of Employer</a>
                  </div>
                </div>
              @endif
              ...
              <form id="show_student" class="form-horizontal toggleForm" enctype="multipart/form-data" action="{{ route('admin.institute.head.employee.store')}}" method="post">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="alt_phone">Telephone Number </label>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-4 mt-3">
                    <div class="form-group">
                      <label for="image">Logo (Upload)</label>
