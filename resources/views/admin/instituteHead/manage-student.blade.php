      ...
      <div class="card">
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Manage Graduate/Student</h2>
            </header>
            <div class="panel-body">
              @if(\App\Helper\CustomHelper::canView('List Of Institute', 'Super Admin|Institute Head'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.institute.head.student.list') }}" class="brn btn-success btn-sm">List of Graduates/Students</a>
                  </div>
                </div>
              @endif
                ...
                <div class="row pb-3 mt-3 ">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="trade_technology_id" id="trade_technology_id"
                              class="form-control @error('trade_technology_id') is-invalid @enderror">
                        <option value="">Choose a Trade/Technology</option>
                        @foreach ($technologies as $item)
                          <option value="{{ $item->id }}"
                                  @if(old('$item->id', $user->trade_technology_id) ==  $item->id ) selected @endif>{{ $item->name }}</option>
                        @endforeach
                      </select>
        ...
        <option value="2">Second Shift</option> --}}
                        @foreach ($datas as $item)
                          <option value="{{ $item->id }}"
                                  @if(old('$item->id', $user->shift_id) ==  $item->id ) selected @endif>{{ $item->name }}</option>
                        @endforeach
                      </select>
                      @error('shift_id')
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select id="semester_id" name="semester_id"
                              class="form-control select-or-disable @error('semester_id') is-invalid @enderror">
        ...
        <option value="8">Semester 8</option> --}}
                        @foreach ($semester as $item)
                          <option value="{{ $item->id }}"
                                  @if(old('$item->id', $user->semester_id) ==  $item->id ) selected @endif>{{ $item->name }}
                          </option>
                        @endforeach
                      </select>
                      @error('semester_id')
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="s_session" id="s_session" placeholder="2021-2022" autocomplete="off"
                             ...
                             value="{{ old('s_session',$user->session) }}">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="number" name="board_roll" id="board_roll" placeholder="Enter Your SSC Board Roll"
                             ...
                             value="{{ old('board_roll',$user->board_roll) }}">
                      <span class="spin"></span>
                      @error('board_roll')
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="number" name="running_board_roll" id="running_board_roll"
                             ...
                             value="{{ old('running_board_roll',$user->running_board_roll )}}">
                      <span class="spin"></span>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="admission_year" id="admission_year" placeholder="Admission Year"
                             ...
                             value="{{ old('admission_year',$user->admission_year ) }}">
                      <span class="spin"></span>
                      ...
                      <select name="employment_status" required
                        ...
                        @foreach (\App\Models\User::$employmentArrays as $employment_status)
                          <option value="{{ $employment_status }}"
                                  @if (old('employment_status',$user->employment_status) == $employment_status) selected @endif>{{ ucfirst($employment_status) }}
                          </option>
                        @endforeach
                      </select>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="employing_company" id="employing_company"
                             ...
                             value="{{ old('employing_company',$user->employing_company) }}">
                      <span class="spin"></span>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="birth_certificate" name="birth_certificate"
                             placeholder="Your Birth Certificate NO."  value="{{ old('birth_certificate',$user->birth_certificate) }}"
