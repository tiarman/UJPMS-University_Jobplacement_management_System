        ...
        <div class="col-sm-12 col-lg-6 contact-info">
            ...
            <div class="mt-3 p-3">
                ...
                <p>
                    ...
                    <br>
                    <strong>Phone:</strong> +8801322919722<br>
                    <strong>Phone:</strong> +8801322919721<br>
...
{{--                <div class="form-group mt-3">--}}
{{--                    <label class="form-label input-label" for="contact_message">Message</label>--}}
{{--                    <input type="text" name="contact_message" id="contact_message" placeholder="Enter Your contact_message"--}}
{{--                           class="form-control @error('contact_message') is-invalid @enderror" value="{{ old('contact_message') }}" required>--}}
{{--                    <span class="spin"></span>--}}
{{--                    @error('contact_message')--}}
{{--                    <strong class="text-danger">{{ $errors->first('contact_message') }}</strong>--}}
{{--                    @enderror--}}
{{--                </div>--}}
                <div class="form-group mt-3">
                  <label class="form-label input-label" for="contact_message">How can we help you?</label>
                    <textarea type="text" name="contact_message" id="contact_message"  class="form-control @error('contact_message') is-invalid @enderror" placeholder="Write message here" required cols="30" rows="10"></textarea>
                  <span class="spin"></span>
                  @error('contact_message')
                  <strong class="text-danger">{{ $errors->first('contact_message') }}</strong>
                  @enderror
