              ...
              @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="institute_id" id="institute_id"
                                class="form-control @error('institute_id') is-invalid @enderror">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @error('department_id')
                                <strong class="text-danger">{{ $error->first('department_id') }}</strong>
                            @enderror
                        </div>
                    </div>
                    {{-- <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select id="semester_id" name="semester_id"
                                ...
                                @foreach ($semester as $item)
                                    <option value="{{ $item->id }}" @selected($item->id == old('semester_id'))>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('semester_id')
              ...
              @enderror
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                          ...
                          <input type="number" name="phone" id="phone" placeholder="01xxxxxxxxx"
                ...
                {{-- <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_bn" placeholder="বাংলায় পুরো নাম" required
                                value="{{ old('name_bn') }}"
          ...
          <div class="col-md-4" >
            <div class="image_preview_container text-center mx-auto" >
                ...
                <div class="row" style="justify-content: center">
                    <div class="mb-5 col-md-12" style="justify-content: center; margin-top:60px">
                        <button class="btn btn-register text-center w-100" type="submit">Register</button>
                    </div>
                </div>
