                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7 col-md-9">
                                        <div class="job-list-desc">
                                            ...
                                            <p class="text-muted mb-0"><i class="mdi mdi-bank mr-2"></i>{{ $val->user->name_en }}</p>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item mr-3">
                                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>{{ $val->location }}</p>
                                                </li>

                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><i class="mdi mdi-clock-outline mr-2"></i>{{ $val->created_at }}</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
