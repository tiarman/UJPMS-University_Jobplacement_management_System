...
class SettingController extends Controller
{
    public function index() {
      ...
      public function manage($id = null)
      {
        ...
        return RedirectHelper::routeWarningWithParams('admin.setting.manage', '<strong>Sorry!!!</strong> Slider not found');
      }
      ...
      public function store(Request $request) {
        ...
        try {
          ...
          return RedirectHelper::routeSuccessWithParams('admin.setting.list', $message);
