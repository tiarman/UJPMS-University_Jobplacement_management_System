      ...
      try {
        ...
        if ($institute->save()) {
          ...
          try {
            ...
            \Illuminate\Support\Facades\Mail::to($institute->email)->cc([$user->email])->send(new \App\Mail\InstituteRegistrationMail($institute->name, $institute->code, $user->name_en));
          } catch (\Exception $e) {
          }
