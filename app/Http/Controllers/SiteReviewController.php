...
class SiteReviewController extends Controller
{
    ...
    public function manage($id = null)
    {
        ...
        return RedirectHelper::routeWarningWithParams('admin.sitereview.list', '<strong>Sorry!!!</strong> SiteReview not found');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($sitereview->save()) {
                ...
                return RedirectHelper::routeSuccessWithParams('admin.sitereview.list', $message);
            }
